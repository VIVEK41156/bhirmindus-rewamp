    ...
    submenu: [
      {
        id: 'forex',
        label: 'Forex',
        desc: 'International currency & financial markets',
        icon: TrendingUp,
        href: '/projects',
      },
      {
        ...
        desc: 'Global commodity procurement & supply',
        icon: BarChart2,
        href: '/projects',
      },
      {
        ...
        desc: 'Certified large-scale production solutions',
        icon: Factory,
        href: '/projects',
      },
      {
        id: 'farming',
        label: 'Corporate Farming',
        desc: 'Sustainable agri-business at scale',
        icon: Leaf,
        href: '/projects',
      },
      {
        id: 'ravens',
        label: "Raven's Ait Island",
        desc: 'Premium riverside venue & leisure',
        icon: Anchor,
        href: '/projects',
      },
      {
        id: 'mit',
        label: 'MIT Institutions',
        desc: 'Education & research partnerships',
        icon: GraduationCap,
        href: '/projects',
      },
    ],
